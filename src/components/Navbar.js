          ...
          <div className="hidden md:block">
            <div className="flex items-center space-x-2">
              ...
              <div className="relative ml-4">
                ...
                {showNotifications && (
                  <div className="absolute right-0 mt-2 w-80 bg-white dark:bg-gray-800 rounded-lg shadow-lg z-50 border border-gray-200 dark:border-gray-700" role="menu" aria-label="Notifications">
